...
//#region node_modules/graphology/dist/graphology.umd.min.js
var require_graphology_umd_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		function a(t) {
			...
			return a = function(t) {
				...
				return a.prototype = Object.create(t.prototype, { constructor: {
					value: a,
					enumerable: !1,
					writable: !0,
					configurable: !0
		...
		var g, y = { exports: {} }, w = "object" == typeof Reflect ? Reflect : null, v = w && "function" == typeof w.apply ? w.apply : function(t, e, n) {
		...
		y.exports = m, y.exports.once = function(t, e) {
			return new Promise((function(n, r) {
				...
				U(t, e, o, { once: !0 }), "error" !== e && function(t, e, n) {
		...
		function x(t, e, n, r) {
			...
			else if ("function" == typeof a ? a = o[e] = r ? [n, a] : [a, n] : r ? a.unshift(n) : a.push(n), (i = G(t)) > 0 && a.length > i && !a.warned) {
				a.warned = !0;
				var u = /* @__PURE__ */ new Error("Possible EventEmitter memory leak detected. " + a.length + " " + String(e) + " listeners added. Use emitter.setMaxListeners() to increase limit");
		...
		Object.defineProperty(m, "defaultMaxListeners", {
			...
			if (r) {
				...
				var a = /* @__PURE__ */ new Error("Unhandled error." + (o ? " (" + o.message + ")" : ""));
				throw a.context = o, a;
			}
			var c = i[t];
		...
		var P = function(t) {
			...
			for (var n, r = arguments.length > 1 ? e : Infinity, i = r !== Infinity ? new Array(r) : [], o = 0, a = R(t);;) {
				if (o === r) return i;
			...
			},
			{
				...
				attacher: function(t, e, n) {
					t.prototype[e] = function(t, r, i, o) {
						...
						var s = c.attributes;
						return s[u] = d(s[u]), this.emit("nodeAttributesUpdated", {
							key: c.key,
							type: "set",
							attributes: c.attributes,
							name: u
		...
		var zt = function(n) {
			function r(t) {
				...
				return p(c(e), "_attributes", {}), p(c(e), "_nodes", /* @__PURE__ */ new Map()), p(c(e), "_edges", /* @__PURE__ */ new Map()), p(c(e), "_directedSize", 0), p(c(e), "_undirectedSize", 0), p(c(e), "_directedSelfLoopCount", 0), p(c(e), "_undirectedSelfLoopCount", 0), p(c(e), "_edgeKeyGenerator", (function() {
					var t;
					do
						t = i + o++;
...
//#endregion
export default require_graphology_umd_min();
